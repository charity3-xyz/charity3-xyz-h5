                ...
                secondary={
                  <React.Fragment>
                    ...
                    <Typography
                      ...
                      introduction This is the This is the introductionThis is the introduction This is the introduction
                      This is the introduction This is the introduction This is the This is the introductionThis is the
                    </Typography>
                    <BorderLinearProgress
                      ...
                      value={50}
                    />
                    <Grid container sx={{ margin: '.375rem', fontWeight: 400, color: '#81858C', fontSize: '.875rem' }}>
                      <Grid item xs={4}>
                        55% raised
                      </Grid>
                      <Grid item xs={4}>
